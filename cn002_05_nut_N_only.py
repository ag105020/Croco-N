...
#--Legend--
subplot(2,2,1)
errorbar([],[],[],fmt='o',color='#548235',markeredgecolor='k',elinewidth=1,ecolor='k',capthick=1,capsize=8,zorder=11,label='Data')
plot([],[],label='Interpo.',color='#548235')
legend(loc=1,edgecolor='k',fontsize=12)

subplot(2,2,2)
errorbar([],[],[],fmt='o',color='#305496',markeredgecolor='k',elinewidth=1,ecolor='k',capthick=1,capsize=8,zorder=11,label='Data')
plot([],[],label='Interpo.',color='#305496')
legend(loc=1,edgecolor='k',fontsize=12)
...
Savefig3('02\\13 Croco N','Nut N',300)
