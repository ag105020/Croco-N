...
#oooooooooooooooooooooooooooooooooooooooo
#----- Mu max (d-1)--------------------
Mo[1] = 1.3 #(d-1) MuMaxCroNO3
Mo[2] = 8 #(d-1) MuMaxCroNH4
Mo[3] = 0.5 #(d-1) MuMaxOthNO3
Mo[4] = 0.9  #(d-1) MuMaxOthNH4

#----- Ks (umol L-1)-------------------
Ko[1] = 0.09 #(umol L-1) KsCroNO3
Ko[2] = 0.07 #(umol L-1) KsCroNH4
Ko[3] = 0.7 #(umol L-1) KsOthNO3
Ko[4] = 0.002 #(umol L-1) KsOthNH4
...
M1 = Mo[1] #(d-1) MuMaxNO3 Croco
M2 = Mo[2] #(d-1) MuMaxNH4 Croco
M3 = Mo[3] #(d-1) MuMaxNO3 Other
M4 = Mo[4] #(d-1) MuMaxNH4 Other
 
K1 = Ko[1] #(umol L-1) KsNO3 Croco
K2 = Ko[2] #(umol L-1) KsNH4 Croco
K3 = Ko[3] #(umol L-1) KsNO3 Other
K4 = Ko[4] #(umol L-1) KsNH4 Other
...
for i in U[:-1]:
    ...
    MuCroN = (M1*NO3[i]/(NO3[i]+K1) + M2*NH4[i]/(NH4[i]+K2))

    MuCro[i] = (M1*NO3[i]/(NO3[i]+K1) + M2*NH4[i]/(NH4[i]+K2))
    dNcroDt = MuCro[i]*Ncro[i] - Nzoo[i]*Gcro#- mcro*Ncro[i]
...
Savefig3('02\\13 Croco N','NO3_no_N2_0.1',300)
